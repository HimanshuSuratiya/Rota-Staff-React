          ...
          <div className="nav-links">
            <nav>
              <ul>
                ...
                <li><button href="#" className="openbtn" onClick={openNav}><span className="plus_icon"><i
                  className="fa fa-plus-circle"></i></span>Actions</button></li>
                <div id="mySidepanel" className="sidepanel">
                  <ul>
                    <div className="d-flex justify-content-between align-items-center">
                      <h5>Add absence</h5>
                      <a href="javascript:void(0)" className="closebtn" onClick={closeNav}>close</a>
                    </div>
                    <li>
                      <div className="d-flex align-items-center">
                        <svg width="30" className="svgColor mr-4 fill-link-link" height="30" viewBox="0 0 32 32"
                          xmlns="http://www.w3.org/2000/svg">
                          <path
                            d="M16 28C15.448 28 15 27.552 15 27V25C15 24.448 15.448 24 16 24C16.552 24 17 24.448 17 25V27C17 27.552 16.552 28 16 28Z">
                          </path>
                          <path
                            d="M25.707 24.293C25.888 24.474 26 24.724 26 25C26 25.552 25.552 26 25 26C24.724 26 24.474 25.888 24.293 25.707L22.293 23.707C22.112 23.526 22 23.276 22 23C22 22.448 22.448 22 23 22C23.276 22 23.526 22.112 23.707 22.293L25.707 24.293Z">
                          </path>
                          <path
                            d="M7.707 25.707C7.526 25.888 7.276 26 7 26C6.448 26 6 25.552 6 25C6 24.724 6.112 24.474 6.293 24.293L8.293 22.293C8.474 22.112 8.724 22 9 22C9.552 22 10 22.448 10 23C10 23.276 9.888 23.526 9.707 23.707L7.707 25.707V25.707Z">
                          </path>
                          <path
                            d="M27 17H25C24.448 17 24 16.552 24 16C24 15.448 24.448 15 25 15H27C27.552 15 28 15.448 28 16C28 16.552 27.552 17 27 17Z">
                          </path>
                          <path
                            d="M7 17H5C4.448 17 4 16.552 4 16C4 15.448 4.448 15 5 15H7C7.552 15 8 15.448 8 16C8 16.552 7.552 17 7 17Z">
                          </path>
                          <path
                            d="M16 22C12.691 22 10 19.308 10 16C10 12.692 12.691 10 16 10C19.309 10 22 12.692 22 16C22 19.308 19.308 22 16 22ZM16 12C13.794 12 12 13.794 12 16C12 18.206 13.794 20 16 20C18.206 20 20 18.206 20 16C20 13.794 18.206 12 16 12Z">
                          </path>
                          <path
                            d="M24.293 6.293C24.474 6.112 24.724 6 25 6C25.552 6 26 6.448 26 7C26 7.276 25.888 7.526 25.707 7.707L23.707 9.707C23.526 9.888 23.276 10 23 10C22.448 10 22 9.552 22 9C22 8.724 22.112 8.474 22.293 8.293L24.293 6.293V6.293Z">
                          </path>
                          <path
                            d="M6.293 7.707C6.112 7.526 6 7.276 6 7C6 6.448 6.448 6 7 6C7.276 6 7.526 6.112 7.707 6.293L9.707 8.293C9.888 8.474 10 8.724 10 9C10 9.552 9.552 10 9 10C8.724 10 8.474 9.888 8.293 9.707L6.293 7.707V7.707Z">
                          </path>
                          <path
                            d="M16 8C15.448 8 15 7.552 15 7V4.875C15 4.323 15.448 3.875 16 3.875C16.552 3.875 17 4.323 17 4.875V7C17 7.552 16.552 8 16 8Z">
                          </path>
                        </svg>
                        <Link to="/annual-leave">Add Annual leave</Link>
                      </div>
                    </li>
                    <li>
                      <div className="d-flex align-items-center">
                        <svg width="30" className="svgColor mr-4 fill-link-link" height="30" viewBox="0 0 32 32"
                          ...
                          <path
                            d="M12 21C12 21.552 11.552 22 11 22C10.448 22 10 21.552 10 21C10 20.448 10.448 20 11 20C11.552 20 12 20.448 12 21Z">
                          </path>
                          <path
                            d="M17 16C17 16.552 16.552 17 16 17C15.448 17 15 16.552 15 16C15 15.448 15.448 15 16 15C16.552 15 17 15.448 17 16Z">
                          </path>
                          <path
                            d="M22 11C22 11.552 21.552 12 21 12C20.448 12 20 11.552 20 11C20 10.448 20.448 10 21 10C21.552 10 22 10.448 22 11Z">
                          </path>
                        </svg>
                        <Link to="/add-sickness">Add Sickness</Link>
                      </div>
                    </li>
                    <li>
                      <div className="d-flex align-items-center">
                        <svg width="30" height="30" className="svgColor mr-4 fill-link-link" viewBox="0 0 32 32"
                          xmlns="http://www.w3.org/2000/svg">
                          <path
                          ...
                          <path
                            d="M19.55 17.163L17 15.463V13C17 12.45 16.55 12 16 12C15.45 12 15 12.45 15 13V16C15 16.35 15.175 16.65 15.45 16.837L18.45 18.837C18.613 18.937 18.8 19 19 19C19.55 19 20 18.55 20 18C20 17.65 19.825 17.35 19.55 17.163Z">
                          </path>
                        </svg>
                        <Link to="/add-lateness">Add Lateness</Link>
                      </div>
                    </li>
                    <li>
                      <div className="d-flex align-items-center">
                        ...
                        <Link to="/add-other-absence">Add Other absences</Link>
                      </div>
                    </li>
                  </ul>
                  <div className="stafTime mt-5">
                    <ul>
                      ...
                      <li>
                        <div className="d-flex align-items-center">
                          <svg width="30" height="30" className="svgColor mr-4 fill-link-link" viewBox="0 0 32 32"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                              d="M22.775 16.837C23.55 15.262 24 13.55 24 11.999C24 7.58702 20.413 3.99902 16 3.99902C11.587 3.99902 8 7.58702 8 11.999C8 13.549 8.438 15.262 9.225 16.837C6.137 18.262 4 21.387 4 25C4 26.65 5.35 28 7 28H25C26.65 28 28 26.65 28 25C28 21.387 25.863 18.262 22.775 16.837ZM16 6.00002C19.313 6.00002 22 8.68802 22 12C22 13.713 21.288 15.762 20.137 17.363C18.937 19.038 17.425 20 16 20C14.575 20 13.062 19.038 11.863 17.363C10.713 15.763 10 13.713 10 12C10 8.68702 12.688 6.00002 16 6.00002ZM25 26H7C6.45 26 6 25.55 6 25C6 22.113 7.763 19.625 10.262 18.562C11.862 20.774 13.899 22 16 22C18.101 22 20.137 20.775 21.738 18.562C24.238 19.637 26 22.112 26 25C26 25.55 25.55 26 25 26Z">
                            </path>
                          </svg>
