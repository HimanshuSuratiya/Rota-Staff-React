                  ...
                  <ul>
                    ...
                    <li>
                      <div className="d-flex align-items-center">
                        ...
                        <a href="annual-leave.html">Add Annual leave</a>
                      </div>
                    </li>
                    <li>
                      <div className="d-flex align-items-center">
                        ...
                        <a href="add-sickness.html">Add Sickness</a>
                      </div>
                    </li>
                    <li>
                      <div className="d-flex align-items-center">
                        ...
                        <a href="add-lateness.html">Add Lateness</a>
                      </div>
                    </li>
                    <li>
                      <div className="d-flex align-items-center">
                        ...
                        <a href="other-absence.html">Add Other absences</a>
                      </div>
                    </li>
                  </ul>
